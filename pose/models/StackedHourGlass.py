...
import modules.StackedHourGlass as M



__all__ = ['StackedHourGlass', 'hg2']
...
class StackedHourGlass(nn.Module):
	...
	def __init__(self, nChannels=256, nStack=2, nModules=1, numReductions=4, nJoints=68):
...
def hg2(**kwargs):
    model = StackedHourGlass(nStack=kwargs['num_stacks'], numReductions=kwargs['num_blocks'],
                         nJoints=kwargs['num_classes'])
    return model
